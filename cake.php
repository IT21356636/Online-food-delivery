...
<section class="menu1" id="menu1">
	 <h1 class="heading1"><span>Yummy</span> Sweet Cakes</h1>
	 <div class="box-container">
		 		 
        <?php
            $query = "select * from food where image like 'c%'";
            $result = mysqli_query($connection,$query);
            if(mysqli_num_rows($result)>0){
                while($row = mysqli_fetch_array($result)){
                    ?>
                    <div class="box">						
                        <form method="post" action="cake.php?action=add&id=<?php echo $row["id"];?>">
                            <div class="cake">
								<div class="image">
